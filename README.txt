Module Purpose
-----------------------------------------------------------------------
gtd is designed as a user-friendly helpdesk application for the XOOPS
portal system. 
...
Click on 'Check Tables' from the gtd Main Menu, or the pop-up menu.
Adjust module preferences as necessary.
Follow steps in "Block Styles" section of this document.
...
flag in the gtd blocks (My Tickets, Recently Viewed Tickets) you will
need to add the following style to your xoops theme's stylesheet:

#gtd_dept_recent li.overdue {background-color:red;}
#gtd_bOpenTickets li.overdue {background-color:red;}

In addition we recommend adding these styles to your theme's stylesheet

#gtd_dept_recent li {list-style:none;}
#gtd_bOpenTickets li {list-style:none;}

#gtd_dept_recent ul, #gtd_dept_recent li {margin:0; padding:0;}
#gtd_bOpenTickets ul, #gtd_bOpenTickets li {margin:0; padding:0;}

#gtd_dept_recent li {margin:0;padding-left:18px; background:url('../../modules/gtd/images/ticket-small.png') no-repeat 0 50%; line-height:16px;padding-bottom:2px;}
#gtd_bOpenTickets li {margin:0;padding-left:18px; background:url('../../modules/gtd/images/ticket-small.png') no-repeat 0 50%; line-height:16px;padding-bottom:2px;}
...
the gtd Admin Panel. Next, edit the department you wish to hold the newly
...
Default Ticket Priority - Adjust default genre for incoming tickets.
...
*/2 * * * * /usr/bin/wget -q <XOOPS_URL>/modules/gtd/checkemail.php
...
this variant:
C:\php\php.exe "<XOOPS_ROOT_PATH>\modules\gtd\checkemail.php"
...
application go to the gtd development site:

http://dev.xoops.org/modules/xfmod/project/?gtd

Translations
-----------------------------------------------------------------------
xHelp not available in your language? Want to help by translating gtd
into your native tongue? Please come to the translators forum on the 
gtd development site (url listed above) for more details.

Credits and Thanks
-----------------------------------------------------------------------
See the about page in gtd Admin area