...
/**
 * gtdStaffReview class
 *
 * @author Eric Juden <ericj@epcusa.com> 
 * @access public
 * @package gtd
 */
class gtdStaffReview extends XoopsObject {
    function gtdStaffReview($id = null) 
	{
...
/**
 * gtdStaffReviewHandler class
 *
 * StaffReview Handler for gtdStaffReview class
 *
 * @author Eric Juden <ericj@epcusa.com> &
 * @access public
 * @package gtd
...
class gtdStaffReviewHandler extends gtdBaseObjectHandler {	
	/**
     * Name of child class
     * 
     * @var	string
     ...
     */	
	function gtdStaffReviewHandler(&$db)
	{
	    parent::init($db);
    }
    ...
    * @return object (@link gtdStaffReview}
    * @access public
    */
