...
/**
 * gtdSavedSearch class
 *
 * @author Eric Juden <ericj@epcusa.com> 
 * @access public
 * @package gtd
 */ 
class gtdSavedSearch extends XoopsObject {
    function gtdSavedSearch($id = null) 
	{
...
/**
 * gtdSavedSearchHandler class
 *
 * SavedSearch Handler for gtdSavedSearch class
 *
 * @author Eric Juden <ericj@epcusa.com> &
 * @access public
 * @package gtd
...
class gtdSavedSearchHandler extends gtdBaseObjectHandler {
	/**
     * Name of child class
     * 
     * @var	string
     ...
     * @access private
     */
     var $_dbtable = 'gtd_saved_searches';
     ...
     */	
	function gtdSavedSearchHandler(&$db)
	{
	    parent::init($db);
    }
