 ...
 */
 ...
 class gtdFile extends XoopsObject {
    function gtdFile($id = null) 
	{
	...
	{
	    $path = GTD_UPLOAD_PATH . '/'. $this->getVar('filename');
	    return $path;
	}
	...
	{
	    $ret = rename(GTD_UPLOAD_PATH."/".$oldName, GTD_UPLOAD_PATH."/".$newName);
...
/**
 * gtdFileHandler class
 *
 * File Handler for gtdFile class
 *
 * @author Eric Juden <ericj@epcusa.com>
 * @access public
 * @package gtd
...
class gtdFileHandler extends gtdBaseObjectHandler {
