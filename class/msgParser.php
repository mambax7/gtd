...
define('HEADER_GENRE', 'Importance');
define('_GTD_MSGTYPE_TICKET', 1);
define('_GTD_MSGTYPE_RESPONSE', 2);



require_once(GTD_PEAR_PATH.'/Mail/mimeDecode.php');

/**
 * gtdMessageParser class
 *
...
class gtdEmailParser
{
    ...
    function &parseMessage(&$msg)
    {
        ...
        $newMsg  = new gtdParsedMessage($struct);
    ...
    {
        $pattern = '/^\*{4}\s'. _GTD_TICKET_MD5SIGNATURE . '\s(.)*\*{4}/im';
...
class gtdParsedMessage
{
    ...
    function gtdParsedMessage(&$msg)
    {
       ...
       $this->_msgtype     = (strlen($msg['hash']) == 0 ? _GTD_MSGTYPE_TICKET : _GTD_MSGTYPE_RESPONSE);
    ...
    {
        $pri = $this->getHeader(HEADER_GENRE);
