...
define('_GTD_CATEGORY1', 'Assigner un professeur');
...
define('_GTD_SEC_TEXT_TICKET_OWNERSHIP', 'Changer le professeur de l\'inscription');
...
define('_GTD_MESSAGE_CLAIM_OWNER_ERROR', 'Erreur : professeur de l\'inscription non d&eacute;efini');
define('_GTD_MESSAGE_ASSIGN_OWNER', 'Vous avez associ&eacute; avec succ&egrave;s un professeur &agrave; cette Inscription');
define('_GTD_MESSAGE_ASSIGN_OWNER_ERROR', 'Erreur : professeur de l\'inscription non d&eacute;fini;');
define('_GTD_MESSAGE_UPDATE_OWNER', 'Mise &agrave; jour du professeur de l\'inscription r&eacute;ussie.');
...
define('_GTD_MESSAGE_ALREADY_OWNER', '%s est d&eacute;j&agrave; professeur de cette Inscription');
...
define('_GTD_MESSAGE_NOOWNER', 'Pas de professeur.');
...
define('_GTD_MESSAGE_NO_INSCRIPTION', 'Bienvenue sur GotoDance.fr, <br><br>
Pour pouvoir vous inscrire &agrave; une soir&eacute;e ou un cours il est necessaire de vous inscrire sur notre site.
<a href="http://www.gotodance.fr/register.php" >Cliquez ici </a>');
...
define('_GTD_MESSAGE_NO_CHANGE_OWNER', 'Vous ne disposez pas des permissions pour changer de professeur.');
...
define('_GTD_MODALITE1', 'Paiement en 1 fois');
define('_GTD_MODALITE2', 'Paiement en 2 fois');
define('_GTD_MODALITE3', 'Paiement en 3 fois');
define('_GTD_MODALITE4', 'Paiement en 4 fois');
define('_GTD_MODALITE5', 'Paiement en 5 fois');
define('_GTD_MODALITE6', 'Paiement en 6 fois');
define('_GTD_MODALITE7', 'Paiement en 7 fois');
define('_GTD_MODALITE8', 'Paiement en 8 fois');
define('_GTD_MODALITE9', 'Paiement en 9 fois');
define('_GTD_MODALITE10', 'Paiement en 10 fois');
define('_GTD_MODALITE10_AVERT', 'Paiement en 10 fois <i><a style="color:#FF0000">(Premiere &eacute;ch&eacute;ance Sept.)</a></i>');
...
define('_GTD_TEXT_GENRE', 'Inscription pour');
define('_GTD_TEXT_PVP', 'Cotisation');
define('_GTD_TEXT_GENRE2', 'Genre');

define('_GTD_TEXT_NOM_DANSEUR', 'Nom Dseur');
define('_GTD_TEXT_PRENOM_DANSEUR', 'Pr&eacute;nom Dseur');
define('_GTD_TEXT_NOM_DANSEUSE', 'Nom Dseuse');
define('_GTD_TEXT_PRENOM_DANSEUSE', 'Pr&eacute;nom Dseuse');
...
define('_GTD_TEXT_OWNER', 'professeur');
...
define('_GTD_TEXT_CLAIMOWNER', 'professeur :');
define('_GTD_TEXT_CLAIM_OWNER', 'Devenir le professeur');
...
define('_GTD_TEXT_LOG_TIME', 'Cr&eacute;&eacute; le ');
define('_GTD_TEXT_OWNERSHIP_DETAILS', 'D&eacute;tails sur le professeur');
...
define('_GTD_TEXT_HIGH_GENRE', 'Inscriptions sans professeur ');
define('_GTD_TEXT_NEW_TICKETS', 'Nouvelles Inscriptions');
...
define('_GTD_TEXT_ACTIONS2', 'Actions & Mises &agrave; jour');
...
define('_GTD_TEXT_OWNERSHIP', 'professeur');
define('_GTD_TEXT_ASSIGN_OWNER', 'Assigner un professeur');
...
define('_GTD_TEXT_SETOWNER', 'Choisir un professeur :');
...
define('_GTD_TEXT_ADD_RESPONSE', 'R&eacute;pondre');
define('_GTD_TEXT_EDIT_TICKET', 'Editer');
define('_GTD_TEXT_DELETE_TICKET', 'Supprimer');
define('_GTD_TEXT_PRINT_TICKET', 'Imprimer');
define('_GTD_TEXT_UPDATE_GENRE', 'le Genre');
...
define('_GTD_BUTTON_UPDATE_GENRE', 'Mettre &agrave; jour');
...
define('_GTD_LOG_ASSIGN_OWNERSHIP', 'professeur assign&eacute;e &agrave; %s');
...
define('_GTD_NO_OWNER', 'Pas de professeur');
