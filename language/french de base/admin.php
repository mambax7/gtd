...
define('_AM_GTD_MENU_MANAGE_DEPARTMENTS', 'Gestion des D&eacute;partements');
define('_AM_GTD_MENU_MANAGE_STAFF', 'Gestion des Equipes');
define('_AM_GTD_MENU_MODIFY_EMLTPL', 'Modifier les Templates des Emails');
define('_AM_GTD_MENU_MODIFY_TICKET_FIELDS', 'Modifier les champs des Tickets');
...
define('_AM_GTD_MENU_ADD_STAFF', 'Ajouter une Equipe');
...
define('_AM_GTD_SEC_TEXT_TICKET_ADD', 'Ajouter des Tickets');
define('_AM_GTD_SEC_TEXT_TICKET_EDIT', 'Modifier des Tickets');
define('_AM_GTD_SEC_TEXT_TICKET_DELETE', 'Supprimer des Tickets');
define('_AM_GTD_SEC_TEXT_TICKET_OWNERSHIP', 'Changer le propri&eacute;taire du Ticket');
define('_AM_GTD_SEC_TEXT_TICKET_STATUS', 'Changer le statut du Ticket');
define('_AM_GTD_SEC_TEXT_TICKET_GENRE', 'Changer la priorit&eacute; du Ticket');
define('_AM_GTD_SEC_TEXT_TICKET_LOGUSER', 'Enregistrer le Ticket pour l\'Utilisateur');
...
define('_AM_GTD_SEC_TEXT_TICKET_MERGE', 'Fusionner des Tickets');
...
// Messages
define('_AM_GTD_MESSAGE_STAFF_UPDATE_ERROR', 'Erreur : &eacute;quipe non mise &agrave; jour');
define('_AM_GTD_MESSAGE_FILE_READONLY', 'Ce fichier est en lecture seule. Merci de rendre le r&eacute;pertoire modules/gtd/language/english/mail_templates ouvert en &eacute;criture');
...
define('_AM_GTD_MESSAGE_DEPT_STORE', 'Permissions du d&eacute;partement enregistr&eacute;s avec succ&egrave;s.');
define('_AM_GTD_MESSAGE_DEPT_STORE_ERROR', 'Erreur: les permissions du d&eacute;partement n\'ont pas &eacute;t&eacute; enregistr&eacute;es.');
...
define('_AM_GTD_MESSAGE_NO_DEPT', 'Erreur: pas de d&eacute;partement sp&eacute;cifi&eacute;');
...
define('_AM_GTD_BUTTON_UPDATESTAFF', 'Mise &agrave; jour Equipe');
...
define('_AM_GTD_EDIT_DEPARTMENT', 'Editer le D&eacute;partement');
define('_AM_GTD_EXISTING_DEPARTMENTS', 'D&eacute;partements existants :');
define('_AM_GTD_MANAGE_DEPARTMENTS', 'Gestion des D&eacute;partements');
define('_AM_GTD_MANAGE_STAFF', 'Gestion des Equipes');
define('_AM_GTD_EXISTING_STAFF', 'Membres actuels de l\'&eacute;quipe :');
define('_AM_GTD_ADD_STAFF', 'Ajouter un membre &agrave; l\'&eacute;quipe');
define('_AM_GTD_EDIT_STAFF', 'Editer les membres de l\'&eacute;quipe');
define('_AM_GTD_INDEX', 'Index');
define('_AM_GTD_DEPARTMENT_SERVERS', 'Boite Mail de D&eacute;partement');
define('_AM_GTD_DEPARTMENT_SERVERS_EMAIL', 'Adresse Email');
define('_AM_GTD_DEPARTMENT_SERVERS_TYPE', 'Type de Boite Mail');
define('_AM_GTD_DEPARTMENT_SERVERS_GENRE', 'Priorit&eacute; par d&eacute;faut du Ticket');
...
define('_AM_GTD_TEXT_HIGH_GENRE', 'Ouvrir un ticket &agrave; Haute priorit&eacute;');
define('_AM_GTD_TEXT_NO_OWNER', 'Pas de propri&eacute;taire');
define('_AM_GTD_TEXT_NO_DEPT', 'Pas de d&eacute;partement');
...
define('_AM_GTD_TEXT_GENRE', 'Priorit&eacute; :');
define('_AM_GTD_TEXT_ELAPSED', 'Ecoul&eacute; :');
define('_AM_GTD_TEXT_STATUS', 'Statut :');
define('_AM_GTD_TEXT_SUBJECT', 'Sujet :');
define('_AM_GTD_TEXT_DEPARTMENT', 'D&eacute;partement :');
define('_AM_GTD_TEXT_OWNER', 'Propri&eacute;taire :');
...
define('_AM_GTD_TEXT_DEPT_PERMS', 'Personnaliser les Permissions du D&eacute;partement');
...
define('_AM_GTD_TEXT_TICKET_INFO', 'Information Ticket');
...
define('_AM_GTD_DEMO_SITE', 'Site de d&eacute;mo 3Dev');
...
define('_AM_GTD_DISCLAIMER', 'Attention: Ce module est en version b&eacute;ta. Il ne doit pas &ecirc;tre utilis&eacute; sur un site de production. Les d&eacute;veloppeurs ne peuvent &ecirc;tre tenus responsables en aucune sorte des troubles pouvant &ecirc;tre occasionn&eacute;s par l\'utilisation de ce module.');
...
define('_AM_GTD_PATH_TICKETATTACH', 'Pi&egrave;ces jointes des Tickets');
...
define('_AM_GTD_TEXT_MANAGE_FIELDS', 'Gestion de champs personnalis&eacute;s');
define('_AM_GTD_ADD_FIELD', 'Ajouter un champs personnalis&eacute;');
define('_AM_GTD_EDIT_FIELD', 'Modification du champ personnalis&eacute;');
define('_AM_GTD_TEXT_NAME_DESC', 'Titre du champs affich&eacute;');
define('_AM_GTD_TEXT_FIELDNAME', 'Nom du champs :');
define('_AM_GTD_TEXT_FIELDNAME_DESC', 'Champs de la base de donn&eacute;e et Nom du Champs au format HTML. Utilisez des caract&egrave;res alphab&eacute;tiques, num&eacute;riques et "_" seulement.');
...
define('_AM_GTD_TEXT_CONTROLTYPE_DESC', 'Type de contr&ocirc;le HTML utilis&eacute;.');
...
define('_AM_GTD_TEXT_REQUIRED_DESC', 'Ce champs devra-t-il &ecirc;tre requis lors de l\'ajout de ticket ?');
...
define('_AM_GTD_TEXT_FIELDVALUES_DESC', 'Exemple:<br />u=Non Sp&eacute;cifi&eacute;<br />m=Homme<br />f=Femme<br /><br />Utilis&eacute; pour les boites de s&eacute;lection ou autre &eacute;l&eacute;ment avec valeurs multiples. L\'information avant le = est le clef,et l\'information apr&egrave;s est la valeur.');
...
define('_AM_GTD_NOTIF_MOD_GENRE', 'Modification de priorit&eacute;');
